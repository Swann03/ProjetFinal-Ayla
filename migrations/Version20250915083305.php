 ...
 */
final class Version20250915083305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE joueur (id INT AUTO_INCREMENT NOT NULL, joueur_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, bio VARCHAR(255) NOT NULL, INDEX IDX_FD71A9C5A9E2D76C (joueur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE statistique (id INT AUTO_INCREMENT NOT NULL, joueur_id INT DEFAULT NULL, statistique_id INT DEFAULT NULL, kill_count INT NOT NULL, dead_count INT NOT NULL, assist_count INT NOT NULL, UNIQUE INDEX UNIQ_73A038ADA9E2D76C (joueur_id), INDEX IDX_73A038AD76A81463 (statistique_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, vote_id INT DEFAULT NULL, rencontre_id INT DEFAULT NULL, point INT DEFAULT NULL, INDEX IDX_5A10856472DCDAFC (vote_id), INDEX IDX_5A1085646CFC0818 (rencontre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE messenger_messages (id BIGINT AUTO_INCREMENT NOT NULL, body LONGTEXT NOT NULL, headers LONGTEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', available_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', delivered_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_75EA56E0FB7336F0 (queue_name), INDEX IDX_75EA56E0E3BD61CE (available_at), INDEX IDX_75EA56E016BA31DB (delivered_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE joueur ADD CONSTRAINT FK_FD71A9C5A9E2D76C FOREIGN KEY (joueur_id) REFERENCES equipe (id)');
        ...
        $this->addSql('ALTER TABLE statistique ADD CONSTRAINT FK_73A038AD76A81463 FOREIGN KEY (statistique_id) REFERENCES rencontre (id)');
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A10856472DCDAFC FOREIGN KEY (vote_id) REFERENCES equipe (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE statistique DROP FOREIGN KEY FK_73A038AD76A81463');
        $this->addSql('ALTER TABLE vote DROP FOREIGN KEY FK_5A10856472DCDAFC');
