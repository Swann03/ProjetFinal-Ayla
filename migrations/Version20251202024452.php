 ...
 */
final class Version20251202024452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE equipe (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, logo VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, image_fond VARCHAR(255) DEFAULT NULL, is_adversaire TINYINT(1) DEFAULT 0 NOT NULL, is_club_principal TINYINT(1) DEFAULT 0 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, rencontre_id INT NOT NULL, equipe_id INT NOT NULL, choix VARCHAR(20) NOT NULL, INDEX IDX_5A108564FB88E14F (utilisateur_id), INDEX IDX_5A1085646CFC0818 (rencontre_id), INDEX IDX_5A1085646D861B89 (equipe_id), UNIQUE INDEX unique_vote (utilisateur_id, rencontre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
