 ...
 */
final class Version20250923094444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE statistique (id INT AUTO_INCREMENT NOT NULL, statistique_id INT DEFAULT NULL, kill_count INT NOT NULL, dead_count INT NOT NULL, assist_count INT NOT NULL, INDEX IDX_73A038AD76A81463 (statistique_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
